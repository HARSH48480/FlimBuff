                    ...
                    <div className="carouselItems" ref={carouselContainer} >
                       {  
                          data?.map((dataItem)=>{
                            ...
                            const posterUrl = dataItem.poster_path ? url.poster + dataItem.poster_path : PosterFallback;
 
                            // console.log(dataItem.media_type,dataItem.id);

                          return <div key={dataItem.id} className="carouselItem" onClick={()=>navigate(`/${endpoint === undefined ? dataItem.media_type : endpoint}/${dataItem.id}`)}>
